...
export default function ChatInput({
  ...
  const [startDate, setStartDate] = useState("10-10-2010");
      ...
      <form onSubmit={handleSubmit} className="max-w-2xl mx-auto">
        ...
        <div className="relative">
          <Input
            ...
            placeholder="Este Galati parte din Romania?"
            className="w-full py-4 px-4 text-lg bg-white border rounded focus:outline-none focus:ring-2 focus:ring-teal-500"
          />
          <Button
            type="submit"
            size="icon"
            className="absolute right-2 top-1/2 transform -translate-y-1/2 translate-x-1/4 bg-teal-600 hover:bg-teal-500 focus:ring-2 focus:ring-teal-400"
          >
